    ...
    for(i=0;i<5;i++)
    {
        for(j=0;j<5;j++)
        {
            ...
            else
            {
                ...
                if(board[i][j] == 'B' || board[i][j] == 'W')    //for some normal moves by mantri
                {
                    gsinput.r = i;
                    gsinput.c = j;
                    k=-1; l=0;
...
int evaluate(bool x, game sinput, game minput, int goFlag)
{
    ...
    int MPvalueTable[5][5]={
        ...
        {p,p,p,p,p},
        {150000,100000,150000,100000,150000},
        {50000,25000,50000,25000,50000},
    ...
    int SPvalueTable[5][5]={
        ...
        {10000,5000,7500,5000,10000},
        {3000,5000,3000,5000,3000},
    ...
    {
        if(Bm==1)    NoM=1500000;
        else if(Bm==2)    NoM=1000000;
        else if(Bm==3)    NoM=100000;
        else if(Bm==4)    NoM=75000;
        else if(Bm==5)    NoM=50000;

    }
    else
    {
        if(Wm==1)    NoM=1500000;
        else if(Wm==2)NoM=1000000;
        else if(Wm==3)    NoM=100000;
        else if(Wm==4)    NoM=75000;
        else if(Wm==5)    NoM=50000;
    }
    ...
    return MSPvalue+Mvalue+NoM+ElimVal;
}
void displayboard ()
{
    int i, j;
