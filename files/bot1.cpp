...
int evaluate(bool x, game sinput, game minput, int goFlag)
{
    ...
    if(board[minput.r][minput.c]==X)
    {
        ...
        else if(x==0)    MSPvalue=MPvalueTable[4-minput.r][minput.c];
    ...
    else
    {
        ...
        else if(x==0)    MSPvalue=SPvalueTable[4-minput.r][minput.c];
    }
    
    if(x==1)
    {
        if(Bm==1)    NoM=500000;
        else if(Bm==2)    NoM=500000;
